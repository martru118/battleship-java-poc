...
public class BattleShipServer2 extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        gridPane.setBackground(new Background(new BackgroundImage(new Image("mainPageShip.jpeg", 500, 500, false, true), BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT)));
        // gridPane.add(sp,0,1);
